...
const styles: Record<VisualizerMode, React.CSSProperties> = {
    ...
    [VisualizerMode.SHAPES]: { background: 'linear-gradient(45deg, #3b82f6 50%, #8b5cf6 50%)' },
    ...
    [VisualizerMode.KALEIDOSCOPE]: { background: 'conic-gradient(#ff00ff, #00ffff, #ffff00, #ff00ff)' },
