...
export const ru = {
  ...
  hints: {
    ...
    sensitivity: 'Управление усилением звука. Высокие значения создают взрывную реакцию.',
    ...
    monitor: 'Направить звук на динамики (Осторожно: возможна обратная связь).',
  ...
  welcomeTitle: 'Aura Vision | Звук Света',
  ...
  unsupportedText: 'Aura Vision требует современных функций Web Audio. Пожалуйста, используйте Chrome, Edge или Safari.',
  ...
  helpModal: {
    title: 'Гайд Aura Vision',
    tabs: {
        guide: 'Гайд',
        shortcuts: 'Клавиши',
        about: 'О проекте'
    },
    intro: 'Aura Vision преобразует звук в генеративное цифровое искусство на основе высокоточного спектрального анализа.',
    ...
    howItWorksSteps: [
      '1. Разрешения: Нажмите "Запустить" и разрешите доступ к микрофону.',
      '2. Музыка: Включите звук рядом, визуал отреагирует мгновенно.',
      '3. Режимы: Откройте панель (H) для выбора одного из 12+ движков.',
      '4. ИИ-Распознавание: Нажмите L для анализа песни и настроения.'
    ],
    ...
    aboutDescription: 'Синестетический опыт нового поколения. Aura Vision объединяет прецизионный анализ с Google Gemini 3 для превращения звука в живой свет. Идеально для VJ, стримеров и инсталляций.',
  ...
  onboarding: {
    welcome: 'Добро пожаловать в Aura Vision',
