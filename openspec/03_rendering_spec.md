...
- **Starfield (星际穿越):** 
  ...
  - 优化：基础速度乘数降低至 10 (原为 20)，以减少视觉混乱感。
- **Nebula (深空星云):** 
...
- **Macro Bubbles (微观液泡):**
  - 逻辑：模拟**景深 (Depth of Field)** 效果。泡泡的清晰度、边缘光（Rim Light）硬度及高光散景（Bokeh）强度均基于其虚拟半径（深度）动态计算，创造虚实对比。
...
---
*Aura Vision Rendering - Version 0.6.8*
